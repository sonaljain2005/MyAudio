...
public class AudioBook extends AudioContent
{
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play()
	{
		String currentChapterTitle= chapterTitles.get(currentChapter);
		String audiofile=  chapters.get(currentChapter);
		super.setAudioFile(currentChapterTitle + "\n" + audiofile);
	...
	public boolean equals(Object other)
	{
		if(super.equals(other))
		{
			...
			if(otherAB.author.equals(author) && otherAB.narrator.equals(narrator))
			{
				return true;
			}
			return false;
